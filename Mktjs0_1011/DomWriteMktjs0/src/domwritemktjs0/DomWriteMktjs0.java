...
public class DomWriteMktjs0 {
	...
	public static void main(String[] args) {
		 try {
	            // Beolvasás az KovacsGergely_orarend.xml fájlból
	            File inputFile = new File("KovacsGergely_orarend.xml");
	            ...
	            // Új fájlba írás
	            saveXMLDocument(doc, "orarend1Mktjs0.xml");
